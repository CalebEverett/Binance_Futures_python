...
class RestApiRequestImpl(object):
    ...
    def get_continuous_contract_data(
        self, pair, contractType, interval, startTime, endTime, limit
    ):
    ...
    def change_position_mode(self, dualSidePosition):
        ...
        request = self.__create_request_by_post_with_signature(
            "/fapi/v1/positionSide/dual", builder
        )
    ...
    def get_top_long_short_accounts(self, symbol, period, startTime, endTime, limit):
        ...
        request = self.__create_request_by_get(
            "/futures/data/topLongShortAccountRatio", builder
        )
    ...
    def get_top_long_short_positions(self, symbol, period, startTime, endTime, limit):
        ...
        request = self.__create_request_by_get(
            "/futures/data/topLongShortPositionRatio", builder
        )
    ...
    def get_blvt_nav_candlestick_data(
        self, symbol, interval, startTime, endTime, limit
    ):
        check_should_not_none(symbol, "symbol")
        check_should_not_none(symbol, "interval")
        builder = UrlParamsBuilder()
    ...
    def auto_cancel_all_orders(self, symbol, countdownTime):
        ...
        request = self.__create_request_by_post_with_signature(
            "/fapi/v1/countdownCancelAll", builder
        )
    ...
    def get_leverage_bracket(self, symbol):
        ...
        request = self.__create_request_by_get_with_signature(
            "/fapi/v1/leverageBracket", builder
        )
    ...
    def get_api_trading_stats(self, symbol):
        ...
        request = self.__create_request_by_get_with_signature(
            "/fapi/v1/apiTradingStatus", builder
        )
